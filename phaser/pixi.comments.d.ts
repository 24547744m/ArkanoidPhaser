...
declare module PIXI {
    ...
    */
    export class BaseTexture implements Mixin {
        ...
        */
        ...
        /**
        * A BaseTexture can be set to skip the rendering phase in the WebGL BrickSprite Batch.
        * 
        * You may want to do this if you have a parent BrickSprite with no visible texture (i.e. uses the internal `__default` texture)
    ...
    */
    ...
    /**
    * Utility methods for BrickSprite/Texture tinting.
    */
    ...
    */
    ...
    /**
    * The BrickSprite object is the base for all textured objects that are rendered to the screen
    */
    export class Sprite extends DisplayObjectContainer {
        ...
        * @return A new BrickSprite using a texture from the texture cache matching the frameId
        */
        ...
        * @return A new BrickSprite using a texture from the texture cache matching the image id
        */
        ...
        *                var sprite = new PIXI.BrickSprite.fromImage('assets/image.png');
        ...
        * 
        * Warning: You cannot have a blend mode and a filter active on the same BrickSprite. Doing so will render the sprite invisible.
        * Default: PIXI.blendModes.NORMAL;
        */
        ...
        * texture this BrickSprite was using.
        * 
    ...
    *    for(var i  = 0; i < 100; i++)
    *    {
    *        var sprite = new PIXI.BrickSprite.fromImage("myImage.png");
    ...
    * to the display list directly. Instead use it as the texture for a PIXI.BrickSprite. If no frame is provided then the whole image is used.
    */
    ...
    * So no need for BrickSprite Batches or BrickSprite Clouds.
    ...
    *    var sprite = PIXI.BrickSprite.fromImage("spinObj_01.png");
    ...
    * 
    * The BrickSprite in this case will be rendered to a position of 0,0. To render this sprite at its actual position a DisplayObjectContainer should be used:
    * 
